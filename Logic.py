...
class Logic:
    ...
    def test1(self):
        ...
        self.board = [[Cl.Men([i, j], 'B') if (i == 6 and j == 1) or (i == 1 and j == 2) else Cl.Men([i, j], 'C')
                                                if i == 2 and j == 1 else Cl.Square([i, j]) if ((i + j) % 2 == 1)
                                                                    else None for j in range(8)] for i in range(8)]

    def test2(self):
        # King attack
        self.board = [[Cl.Men([i, j], 'B') if ((i == 4 and j == 3)or (i == 4 and j == 1)) else Cl.King([i, j], 'C') if (i == 3 and j == 4)
                        else Cl.Square([i, j]) if ((i + j) % 2 == 1) else None for j in range(8)]for i in range(8)]

    def test3(self):
        # Black winner
        self.board = [[Cl.Men([i, j], 'B') if (i == 1 and j == 2) else Cl.Men([i, j], 'C')
                                                if i == 2 and j == 1 else Cl.Square([i, j]) if ((i + j) % 2 == 1)
                                                                    else None for j in range(8)] for i in range(8)]
    ...
    def captured(self, position, black_turn, buttons):
        ...
        self.board[position[0]][position[1]] = Cl.Square([position[0], position[1]])
    ...
    def put_in_board(self, position, player):
        if player == 'C':
            self.board[position[0]][position[1]] = Cl.King([position[0], position[1]], 'C')
        else:
            self.board[position[0]][position[1]] = Cl.King([position[0], position[1]], 'B')

    def clear(self):
        self.attack = [[False for i in range(8)] for j in range(8)]

    def force_attack(self,  blackturn):
        for i in range(8):
            for j in range(8):
                if blackturn:
                    if type(self.board[i][j]) == Cl.Men and self.board[i][j].player == 'C':
                        if j == 0 or j == 1:
                    ...
                    elif type(self.board[i][j]) == Cl.King and self.board[i][j].player == 'C':
                        if j == 0 or j == 1:
                ...
                if not blackturn:
                    if type(self.board[i][j]) == Cl.Men and self.board[i][j].player == 'B':
                        if j == 0 or j == 1:
                    ...
                    elif type(self.board[i][j]) == Cl.King and self.board[i][j].player == 'B':
                        if j == 0 or j == 1:
    ...
    def check_bottom_right(self, position, player):
        if position[0] == 7 or position[0] == 6:
            return False
        if player == 'C':
            if type(self.board[position[0] + 1][position[1] + 1]) == Cl.Men or type(self.board[position[0] + 1][position[1] + 1]) == Cl.King:
                if self.board[position[0]+1][position[1]+1].player == 'B':
                    if type(self.board[position[0]+2][position[1]+2]) == Cl.Square:
    ...
    def check_next_attack(self, position, blackturn):
        if blackturn:
            if type(self.board[position[0]][position[1]]) == Cl.Men and self.board[position[0]][position[1]].player == 'C':
            ...
            elif type(self.board[position[0]][position[1]]) == Cl.King and self.board[position[0]][position[1]].player == 'C':
                if position[1] == 0 or position[1] == 1:
            ...
            if type(self.board[position[0]][position[1]]) == Cl.Men and self.board[position[0]][position[1]].player == 'B':
                if position[1] == 0 or position[1] == 1:
            ...
            elif type(self.board[position[0]][position[1]]) == Cl.King and self.board[position[0]][position[1]].player == 'B':
                if position[1] == 0 or position[1] == 1:
